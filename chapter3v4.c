...
void chapter3v4()
{
	...
	if(b==2)
	{
		...
		if(c==1)
		{
			...
			getch();
			printf("\n As the swords clashed you see Max completely surrendering \n you realize it was a bad decision");
			getch();
			death();
		}
		if(c==2)
